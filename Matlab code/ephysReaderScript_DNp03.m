...
filename = 'fly04_DNp03_hyperpolarization current injection 2pA_with 20sec interval.mat';
...
folder = 'C:\Users\antho\VPN-DN-synapse-normalization\Matlab code';
filename = 'fly05_DNp03_hyperpolarization current injection 2pA_with 20sec interval.mat';File = fullfile(folder, filename);
load(File)
...
folder = 'C:\Users\antho\VPN-DN-synapse-normalization\Matlab code';
filename = 'fly07_DNp03_hyperpolarization current injection 2pA_with 20sec interval.mat';
File = fullfile(folder, filename);
load(File)
...
plot(time - 7.5, fly1_hpol_avg, 'r'); hold on;
hold on
...
plot(time-7.5, STD1,'Color', colorGrey)
hold on
plot(time-7.5, fly2_hpol_avg, 'g')
plot(time-7.5, STD2,'Color', colorGrey)
plot(time-7.5, fly3_hpol_avg, 'b')
plot(time-7.5, STD3,'Color', colorGrey)
% plot(time_300ms, fly4_hpol_avg, 'b')
% plot(time_300ms, fly5_hpol_avg, 'b')
% plot(time_300ms, fly6_hpol_avg, 'b')
ylabel('mV')
...
time_shifted = time - 7.5;
upper_bound = fly1_hpol_avg + STD1;
lower_bound = fly1_hpol_avg - STD1;

% Ensure vectors have the same orientation
if isrow(time_shifted)
...
figure(3);
upper_bound = fly2_hpol_avg + STD2;
lower_bound = fly2_hpol_avg - STD2;
fill([time_shifted; flipud(time_shifted)], ...
     [upper_bound; flipud(lower_bound)], ...
     colorGrey, 'FaceAlpha', 0.2, 'EdgeColor', 'none'); 
hold on
...
figure(4);
upper_bound = fly3_hpol_avg + STD3;
lower_bound = fly3_hpol_avg - STD3;
fill([time_shifted; flipud(time_shifted)], ...
     [upper_bound; flipud(lower_bound)], ...
     colorGrey, 'FaceAlpha', 0.2, 'EdgeColor', 'none'); 
hold on
